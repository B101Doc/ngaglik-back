...
export interface ApiDescDesc extends Schema.SingleType {
  collectionName: 'descs';
  info: {
    singularName: 'desc';
    pluralName: 'descs';
    displayName: 'Tentang Kelurahan';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::desc.desc', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::desc.desc', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
export interface ApiTourismTourism extends Schema.CollectionType {
